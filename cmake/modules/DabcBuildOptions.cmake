...
function(DABC_BUILD_OPTION opt defvalue)
  ...
  set(${opt}_defvalue
      ${defvalue}
      PARENT_SCOPE)
  set(${opt}_description
      ${description}
      PARENT_SCOPE)
  set(dabc_build_options
      ${dabc_build_options} ${opt}
      PARENT_SCOPE)
endfunction()
...
# -----------------------------------------------------------------------------
# Full list of options with their descriptions and default values The default
# value can be changed as many times as we wish before calling
# DABC_APPLY_OPTIONS()
# -----------------------------------------------------------------------------
...
dabc_build_option(gosip ON "Enable GOSIP plugin")
dabc_build_option(hadaq ON "Enable HADAQ plugin")
dabc_build_option(http ON "Enable HTTP plugin")
dabc_build_option(ltsm ON "Enable LTSM plugin")
