...
namespace dabc {
   ...
   // buffer size if limited by 32 bit - 4 gbyte is pretty enougth for single structure
   ...
   class Buffer {
      ...
      public:
         ...
         // this is the only offical method to release buffer 
         // after this call pointer on buffer object is invalid and cannot be used further
         static void Release(Buffer* buf);
         
         // hase same meaning as previous, but value of variable is protected by mutex
