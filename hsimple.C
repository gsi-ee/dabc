...
//  write access to this directory, otherwise the file is created in $PWD
   ...
   hpxpy->SetName("hpxpy[0]");

   DabcRoot::StartHttpServer(8090);
   DabcRoot::StartDabcServer(1237);
   DabcRoot::Register("abc/fold1", hpx);
   DabcRoot::Register("abc/fold2", hpxpy);

   //DabcRoot::Unregister(hpxpy);
