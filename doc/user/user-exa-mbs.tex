...
Script \verba{script/remote_exe.sc}
...
\item Program name.
\item \mbs\ path of program. Script executes \verbs{m\_launch} which forks
...
\lsubsection{user:MbsDimconfig}{\mbs\ configuration of DIM}
