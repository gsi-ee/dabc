...
\section{GUI Panels}
\figpng{user-gui-main-buttons}{Main buttons.}{htb}{0}{0.8}
...
\icon{fileclose} Close without prompt. The \dabc\ will continue to run.
The GUI may be started anywhere again. In case you saved the layout (see \paref{user:guiSaveRestore})
...
Details see \paref{user:guiSaveRestore}.\
\icon{dabcmbsicon} \dabc\ \mbs\ launcher, see \paref{user:launchDabcMbs}.\\
\icon{dabcicon} \dabc\ launcher, see \paref{user:launchDabc}.\\
\icon{mbsicon} \mbs\ launcher, see \paref{user:launchMbs}.\\
\icon{browser}  Browser. Update DIM service list from DIM name server.
...
This update function is called whenever the frontend systems might have
...
\lsubsection{user:launchDabc}{\dabc~ launch panel}
...
This panel is a specific application panel and described in the \mbs\ section \paref{user:launchMbs}.
\subsection{Combined \dabc~ and \mbs~ launch panel}
This panel is a specific application panel and described in the \mbs\ section \paref{user:launchDabcMbs}.
...
All rate meters are displayed in the meter panel, Fig.\paref{user-gui-pan-rate}. 
...
All histograms are displayed in the histogram panel, Fig.\paref{user-gui-pan-histo}. 
