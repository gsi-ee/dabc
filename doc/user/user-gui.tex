...
From left to right the startup a system, configure it, start
...
Values are read from file {\tt DabcLaunch.xml} (default, may be saved/restored to/from other file,
...
\figpng{user-gui-pan-statedabc}{States.}{htb}{0}{1.0}
