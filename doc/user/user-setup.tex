...
with the \dabc\ GUI, as described in section\paref{user:mbsapp}. 
The name of the \dabc\ builder \keyw{<Context>} node and
the setup file name must be specified in the 
Combined {\em DabcMbsController} panel of the GUI, as shown in
Fig. \paref{fig:user-gui-pan-dabcmbs}. Here also the \mbs\
