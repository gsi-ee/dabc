...
\bbul
\item \param{FileName}      - name of lmd file (including .lmd extension)  
\item \param{FileSizeLimit} - size limit (in Mb) of single file, 0 - no limit
\ebul
...
\bbul
\item \param{FileName} - name of lmd file (multicast symbols '*' and '?' are supported)  
...
\begin{verbatim}
   ...
   dabc::mgr.CreateTransport("Generator/Output0", "lmd://output.lmd?maxsize=100");
   ...
\end{verbatim}
\end{small}
...
\begin{verbatim}
   ...
   dabc::CmdCreateModule cmd("mbs::CombinerModule", "Combiner");
   cmd.SetInt(dabc::xmlNumInputs, 3);
   dabc::mgr.Execute(cmd);
   
   for (unisgned n=0;n++;n<3) 
      dabc::mgr.CreateTransport cmd(dabc::format("Combiner/Input%u",n), dabc::format("lmd://intput%u.lmd",n));
   ...
\end{verbatim}
\end{small}
...
Each system socket is assigned to an instance of \class{dabc::SocketWorker}. 
The actual socket event processing is then done in virtual methods
of class \class{dabc::SocketWorker} which has several subclasses for different 
kinds of sockets: 
\bbul
\item  - \class{dabc::SocketServerAddon} - server socket for connection  
\item  - \class{dabc::SocketClientAddon} - client socket for connection  
\item  - \class{dabc::SocketIOAddon} - send/recv handling  
\ebul
...
This is also a good example of the \class{dabc::SocketWorker} classes.
...
\begin{verbatim}
  ...
  dabc::mgr.CreateTransport("Generator/Output", "mbs://Transport", "GeneratorThrd");
  ...
\end{verbatim}
\end{small}
...
\begin{verbatim}
  ...
  dabc::CmdCreateTransport cmd("Generator/Output", "mbs://Transport:6007", "MbsTransThrd");
  dabc::mgr.Execute(cmd);
  ...
\end{verbatim}
\end{small}
...
\begin{verbatim}
  ...
  dabc::mgr.CreateTransport("Combiner/Input0", 
                            "mbs://lxi010.gsi.de/Stream", "MbsTransThrd");
  ...
\end{verbatim}
\end{small}
...
extern "C" void InitMbsGenerator()
{
  ...
  dabc::mgr.CreateTransport("Generator/Output", "mbs://Stream", "GenerThrd");
}
\end{verbatim}
\end{small}
...
<dabc version="1">
  <Context host="lxi009" name="Server">
    ...
    <Module name="Generator">
       ...
       <OutputPort name="Output0" url="mbs://Stream:6006"/>
     </Module>
  </Context>
</dabc>
\end{verbatim}
...
<dabc version="1">
  <Context host="localhost" name="Worker">
    ...
    <Module name="Combiner">
       ...
       <DoServer value="true"/>
       <BufferSize value="16384"/>
       <InputPort name="Input0" url="mbs://lxi009:6000/Transport" queue="5"/>
       <InputPort name="Input1" url="mbs://lxi010:6000/Transport" queue="5"/>
       <InputPort name="Input2" url="mbs://lxi011:6000/Transport" queue="5"/>
       <OutputPort name="FileOutput" url="lmd://combiner.lmd?maxsize=128" queue="5"/>
       <OutputPort name="ServerOutput" url="mbs://Stream" queue="5"/>
     </Module>
  </Context>
</dabc>
\end{verbatim}
