...
\begin{verbatim}
   ...
   dabc::CmdCreateTransport cmd("Generator/Output", mbs::typeLmdOutput);
...
\begin{verbatim}
   ...
   for (unisgned n=0;n++;n<3) {
      dabc::CmdCreateTransport cmd(FORMAT(("Combiner/Input%u",n)), mbs::typeLmdInput);
...
kinds of sockets: 
\bbul
\item  - \class{dabc::SocketServerWorker} - server socket for connection  
\item  - \class{dabc::SocketClientWorker} - client socket for connection  
\item  - \class{dabc::SocketIOWorker} - send/recv handling  
\ebul
...
\begin{verbatim}
  ...
  dabc::CmdCreateTransport cmd("Generator/Output", mbs::typeServerTransport, "MbsTransThrd");
...
\begin{verbatim}
  ...
  dabc::CmdCreateTransport cmd("Combiner/Input0", 
