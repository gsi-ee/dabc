...
The \func{GetPar...()} methods will internally create a new
...
Each parameter has a \strong {visibility level} 
...
configured with \func{Manager::ParsVisibility()}. 
The default parameter visiblity level can be set via
\func{WorkingProcessor::SetParDflts()} function before 
...
In our example one can modify \func{StartMbsGenerator()} function in the following way:
\begin{verbatim}
