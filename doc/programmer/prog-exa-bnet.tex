...
To implement experiment-specific BNET application, user should creates 
...
\class{bnet::BuilderModule} class. In this case the only virtual method
should be implemented - \func{DoBuildEvent}, which produces from N buffers with subevents
