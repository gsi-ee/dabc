...
\item Update all graphics panels (\func{updateAll}). All graphics items had been added;
...
\item Call \func{browser.releaseServices}.
...
\item Call \func{browser.initServices}.
\item Create \class{xPanelParameter}.
...
\class{xiUserCommand} object from first application panel object to \class{xPanelCommand}.
\item Call browser \func{enableServices} function. 
\item Call \func{setCommandDescriptors}.
