...
\begin{figure}[htb]
\centering\includegraphics[angle=0,width=.6\textwidth]{prog-minipanel.png} % pdf file
\caption{Minipanel.}
...
\begin{figure}[htb]
\centering\includegraphics[angle=0,width=.7\textwidth]{prog-ministates.png} % pdf file
\caption{Ministates.}
