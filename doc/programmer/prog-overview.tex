...
The auxiliary class \class{dabc::Pointer} offers methods to transparently 
...
For \class{dabc::ModuleSync}, function \func{MainLoop()} may wait for buffers 
...
In contrast to this, \class{dabc::ModuleAsync} has event callbacks that are executed 
