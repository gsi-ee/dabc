...
\item [\func{Read\_Start()}] : Starts reading of buffer. Should return:
   \bdes
   \item[\keyw{dabc::di\_Ok}]       - normal case, call of \func{Read\_Comlete()} will follow
...
As argument, factories gets application class name, provided from configuration file.
...
There are following SM commands exists:
...
\func{DoStateTransition()} method, where number of virtual methods are called:
