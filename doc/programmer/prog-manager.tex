...
% \item[\em WorkingThread* CreateThread(const char* thrdname, const char* classname = 0, const char* devname = 0, Command cmd = 0)] :
...
\item[\em bool MakeThreadFor\small (Worker* proc, const char* thrdname = 0, unsigned startmode = 0) ] :
