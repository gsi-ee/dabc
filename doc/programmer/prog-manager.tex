...
The command receiver is defined by the full name \func{fullitemname} in the object folder structure, e.~g.~ "Devices/Socket".
...
is defined by the full name \func{fullitemname} in the object folder structure,
e.~g.~ "ReadoutModule1". The caller must provide a command client object
