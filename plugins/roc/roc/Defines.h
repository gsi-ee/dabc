...
#define ROC_MASTER_LOGIN            0x030A // r/w
#define ROC_MASTER_DATAPORT         0x030B // r/w  data port of master node
...
#define ROC_BURST_LOOPCNT           0x0326 // r/w - number of readout in burst loops
#define ROC_OCM_LOOPCNT             0x0327 // r/w - number of readout in ocm loops
#define ROC_STATBLOCK               0x0328 // r - block with sc_statistic
#define ROC_DEBUGMSG                0x0329 // r - last output of sc_printf command
#define ROC_HIGHWATER               0x032A // r/w - value of high water marker (in number of UDP buffers, maximum is about 78000 buffers or 112 MB)
#define ROC_LOWWATER                0x032B // r/w - value of low water marker (in number of UDP buffers, default is 10% of highwater)
#define ROC_NUMBUFALLOC             0x032C // r - number of allocated UDP buffers
