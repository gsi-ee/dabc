...
// outname is name without path
 ...
 strcat(out,"_RocFastEvent"); // append name of output event object
...
TRocFastAnalysis* analysis = new TRocFastAnalysis(serv,intype,sport,out,writeout);
