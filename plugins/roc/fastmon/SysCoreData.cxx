   ...
   if (kind & 2)
      switch (getMessageType()) {
         ...
         case ROC_MSG_EPOCH:
            ...
            break;
         case ROC_MSG_SYNC:
            printf("SyncChn:%1x Ts:%04x Evnt:%06x Flag:%02x", getSyncChNum(), getSyncTs(), getSyncEvNum(), getSyncStFlag());
            break;
         case ROC_MSG_AUX:
            printf("AuxChn:%02x Ts:%04x Failing:%1x", getAuxChNum(), getAuxTs(), getAuxFailing());
            break;
         case ROC_MSG_SYS:
