...
//***********************************************************
TRocFastAnalysis::TRocFastAnalysis() : fUserFile(0),fMbsEvent(0){}
//***********************************************************
// this constructor is used in Main program
TRocFastAnalysis::TRocFastAnalysis(const char* input, Int_t type, Int_t port, const char* output, Bool_t enable)
  : fUserFile(0),
    fMbsEvent(0),
    fEvents(0),
    fLastEvent(0)
...
// We will use only one analysis step (factory)
  ...
  factory->DefEventProcessor("RocFastProc","TRocFastProc");// object name, class name
  factory->DefOutputEvent("RocFastEvent","TRocFastEvent"); // object name, class name
  ...
  // if an autosave file is there.
      fPar = new TRocFastParam("Par1");
      AddParameter(fPar);
      fCtl = new TRocFastControl("Control");
      AddParameter(fCtl);
}
//***********************************************************
TRocFastAnalysis::~TRocFastAnalysis()
{
  cout << "**** TRocFastAnalysis: Delete instance" << endl;
}

//-----------------------------------------------------------
Int_t TRocFastAnalysis::UserPreLoop()
{
  // all this is optional:
  cout << "**** TRocFastAnalysis: PreLoop" << endl;
...
//-----------------------------------------------------------
Int_t TRocFastAnalysis::UserPostLoop()
{
  // all this is optional:
   cout << "**** TRocFastAnalysis: PostLoop" << endl;
...
//-----------------------------------------------------------
Int_t TRocFastAnalysis::UserEventFunc()
{
  // all this is optional:
