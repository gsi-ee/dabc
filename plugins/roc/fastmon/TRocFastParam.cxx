...
//***********************************************************
TRocFastParam::TRocFastParam() : TGo4Parameter()
{
  frP1=0;
  frP2=0;
  fiNum=0;
...
//***********************************************************
TRocFastParam::TRocFastParam(const char* name) : TGo4Parameter(name)
{
  fill=kTRUE;
  frP1=10;
  frP2=20;
...
//***********************************************************
TRocFastParam::~TRocFastParam()
{
}
//***********************************************************

//-----------------------------------------------------------
Int_t TRocFastParam::PrintParameter(Text_t * n, Int_t){
  return 0;
...
//-----------------------------------------------------------
Bool_t TRocFastParam::UpdateFrom(TGo4Parameter *pp){
  if(pp->InheritsFrom("TRocFastParam"))
  {
    TRocFastParam * from;
    from = (TRocFastParam *) pp;
    cout << "**** TRocFastParam " << GetName() << " updated from auto save file" << endl;
    fill=from->fill;
    frP1=from->frP1;
    frP2=from->frP2;
    fiNum=from->fiNum;
