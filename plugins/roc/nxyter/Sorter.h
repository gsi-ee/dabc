...
namespace nxyter {
   ...
   class Sorter {
      protected:
         ...
         Data        *fFillBuffer;     // buffer to fill
         ...
         bool flushBuffer(Data* data, unsigned num_msg, bool force = false);
      ...
      public:
         ...
         bool addData(Data* data, unsigned num_msg, bool flush_data = false);
         ...
         Data* filledBuf() const { return fFillBuffer; }
