...
const char* pex::xmlHTML_Path = "HtmlPath";

pex::Player::Player(const std::string& name, dabc::Command cmd) :
...
void pex::Player::ProcessTimerEvent(unsigned /* timer */)
{
...
int pex::Player::ExecuteCommand(dabc::Command cmd)
{
