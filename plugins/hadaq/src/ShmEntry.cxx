...
hadaq::ShmEntry::ShmEntry(const std::string& statsname, const std::string& shmemname,  ::Worker* handle) :
   fStatsName(statsname),fShmName(shmemname),fWorker(handle),
   fShmPtr(0)
{
...
//void hadaq::ShmEntry::DeleteService()
//{
//   delete fCmd; fCmd = 0;
//
...
//void hadaq::ShmEntry::commandHandler()
//{
//   if (fCmd==0) {
...
//}
//
//std::string hadaq::ShmEntry::CommandDefAsXml(const dabc::CommandDefinition& src)
//{
//   std::string res;
//
...
//}
//
//bool hadaq::ShmEntry::ReadParsFromDimString(dabc::Command& cmd, const dabc::CommandDefinition& def, const char* pars)
//{
...
//bool hadaq::ShmEntry::UpdateEntry(const dabc::Parameter& par)
//{
...
////         if (fService==0) {
////            fService = new ::DimService(fDimName.c_str(), const_cast<char*>(hadaq::RateRecDesc), fBuffer, fBufferLen);
////            SetRecType(hadaq::RATE);
////         }
////
...
////
////         if (fService==0) {
////            fService = new ::DimService(fDimName.c_str(), const_cast<char*>(hadaq::StatusRecDesc), fBuffer, fBufferLen);
////            SetRecType(hadaq::STATUS);
////         }
////
////         break;
////      }
...
////
////         if (fService==0) {
////            fService = new ::DimService(fDimName.c_str(), const_cast<char*>(hadaq::InfoRecDesc), fBuffer, fBufferLen);
////            SetRecType(hadaq::INFO);
////         }
////
////         break;
////      }
...
//void hadaq::ShmEntry::SetQuality(unsigned int qual)
//{
//   fRecStat       = (hadaq::recordstat)  (qual       & 0xff);
//   fRecType       = (hadaq::recordtype)  ((qual>>8)  & 0xff);
//   fRecVisibility = (hadaq::visiblemask) ((qual>>16) & 0xff);
//   fRecMode       = (hadaq::recordmode)  ((qual>>24) & 0xff);
//   if(fService)
//      fService->setQuality(qual);
//}
//
//unsigned hadaq::ShmEntry::GetQuality()
//{
//   return ((unsigned) fRecStat) | ((unsigned) (fRecType) << 8) | ((unsigned)(fRecVisibility) << 16) | ((unsigned) (fRecMode) << 24);
//}
//
//void hadaq::ServiceEntry::SetRecType(hadaq::recordtype t)
//{
//   fRecType = t;
//   if(fService)
...
//}
//
//void hadaq::ServiceEntry::SetRecVisibility(hadaq::visiblemask mask)
//{
//   fRecVisibility = mask;
//   if(fService)
//      fService->setQuality(GetQuality());
//}
//
//void hadaq::ServiceEntry::SetRecStat(hadaq::recordstat s)
//{
//   fRecStat = s;
//   if(fService)
//      fService->setQuality(GetQuality());
//}
//
//void hadaq::ServiceEntry::SetRecMode(hadaq::recordmode m)
//{
//  fRecMode = m;
//  if(fService)
//    fService->setQuality(GetQuality());
