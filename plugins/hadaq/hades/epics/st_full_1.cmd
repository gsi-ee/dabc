...
dbLoadRecords("db/errbit1.db","eb=eb01")
dbLoadRecords("db/errbit2.db","eb=eb01")
dbLoadRecords("db/trignr1.db","eb=eb01")
dbLoadRecords("db/trignr2.db","eb=eb01")
dbLoadRecords("db/portnr1.db","eb=eb01")
dbLoadRecords("db/portnr2.db","eb=eb01")
dbLoadRecords("db/trigtype.db","eb=eb01")
dbLoadRecords("db/cpu.db","eb=eb01")
dbLoadRecords("db/errbitstat.db","eb=eb01")
