 ...
 * Change History:
 * 
 * $Log: testPciDriver.c,v $
 * Revision 1.5  2008/04/07 16:09:07  adamczew
 * *** empty log message ***
 *
 * Revision 1.3  2006-11-17 18:49:01  marcus
 * Added 'type' to the SG-list-get IOctl.
 *
