 ...
 * 
 * $Log: Board.h,v $
 * Revision 1.6  2008/04/08 10:34:08  adamczew
 * *** empty log message ***
 *
 * Revision 1.5  2008/04/07 16:09:01  adamczew
 * *** empty log message ***
 *
...
public:
	 ...
	 * @exception mprace::Exception On error.
	 */
	virtual void writeDMA(const unsigned int address, const DMABuffer& buf, const unsigned int count, const unsigned int offset = 0, const bool inc = true, const bool lock=true );
	 ...
	 * @exception mprace::Exception On error.
	 */
	virtual void readDMA(const unsigned int address, DMABuffer& buf, const unsigned int count, const unsigned int offset = 0, const bool inc = true, const bool lock=true );
	 ...
	 * @exception mprace::Exception On error.
	 */
	virtual ConfigStatus config( const std::string& filename )=0;
	 ...
	 * @exception mprace::Exception On error.
	 */
	virtual ConfigStatus config( const char *filename )=0;
	 ...
	 * @exception mprace::Exception On error.
	 */
	virtual ConfigStatus config( unsigned int byteCount, const char *bitstream )=0;
