 ...
 * 
 * $Log: DMABuffer.h,v $
 * Revision 1.8  2008/05/16 10:40:53  adamczew
 * *** empty log message ***
 *
 * Revision 1.7  2008/04/07 16:09:01  adamczew
 * *** empty log message ***
 *
...
#include "pciDriver/lib/UserMemory.h" 
// <-sync direction is defined here
...
public:
    ...
    /** test JA: may need to sync dma buffers after receive ???????*/
    void syncUsermem(pciDriver::UserMemory::sync_dir direction);
