...
There is a [snapshot (frozen copy)](https://root.cern.ch/js/3.3/demo/) of such server, running in httpserver.C macro from ROOT tutorial.

<iframe width="800" height="500" src="https://root.cern.ch/js/3.3/demo/?layout=grid2x2&item=Canvases/c1">
</iframe>
