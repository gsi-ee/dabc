...
There is a [snapshot (frozen copy)](https://root.cern.ch/js/3.4/httpserver.C/) of such server, running in httpserver.C macro from ROOT tutorial.

<iframe width="800" height="500" src="https://root.cern.ch/js/3.4/httpserver.C/?layout=grid2x2&item=Canvases/c1">
</iframe>
