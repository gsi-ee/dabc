...
public class CbmPanel  extends xPanelPrompt            // provides some simpple formatting
...
{
//----------------------------------------------------------
// using this class for one handler per DIM parameter:
// In constructor we store a meter or a state.
// Then we can in infoHandler process ther parameter in the proper way.
private class myInfoHandler implements xiUserInfoHandler{
private xMeter meter;
private xState state;
private String name;

// Meter and State are exclusively
...
tooltip=new String("Launch CBM panel");
}
...
// Build button line
    ...
    addButton("userStart","Start",startIcon,this);
    addButton("userStop","Stop",stopIcon,this);
...
//    if((full.indexOf("/Eventbuilder:42/Events.")>0)||(full.indexOf("/EventRate")>0)) {
    ...
    // instead of "this" we could create new myInfoHandler
    } // list of parameters
...
if(mbsCommand != null) {
    if(check1.isSelected()) {
    	tellError(this,"Check1 on!");
    	}
    else tellError(this,"Check1 off!");
    }
