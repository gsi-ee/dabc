...
void dabc::StandaloneManager::DisconnectCmdChannels()
{
   ...
   DOUT3(("StandaloneManager::DisconnectCmdChannels chnl = %p", fCmdChannel));
   ...
   if (res)
      DOUT3(("StandaloneManager::DisconnectCmdChannels done"));
   else
